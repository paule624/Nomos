...
function AuthPage({ onLoginSuccess }) {
  ...
  return (
    <div className="relative h-full flex flex-col px-6 bg-[#F2F4F3]">
      {/* Background SVG */}
      <svg
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center justify-center h-full w-full max-w-md mx-auto ">
        <img src={Logo} alt="" className="w-2xs" />
        <div className="w-full bg-white/10 backdrop-blur-md rounded-3xl p-8 shadow-lg mt-5">
          <div className="mb-8 text-center">
            <h2 className="text-2xl font-semibold text-[#22333B]">
